import unittest
from applications_to_csv import extract_row, sanitize_col
...
class TestApplicationsToCsv(unittest.TestCase):
            ...
            "sections": [
                {
                    ...
                    "questions": [
                        {"questionTitle": "Q1", "questionId": "Q1", "questionResponse": "Answer 1"},
                        {"questionTitle": "Q2", "questionId": "Q2", "questionResponse": 42}
                    ]
                },
                {
                    "sectionTitle": "Section 2",
                    "questions": [
                        {"questionTitle": "Q3", "questionId": "Q3", "questionResponse": [1, 2, 3]},
                        {"questionTitle": "Q4", "questionId": "Q4", "questionResponse": {"a": 1, "b": 2}}
                    ]
                }
            ]
        }

    def test_extract_row_structure(self):
        meta, dyn, blocks = extract_row(self.root_meta, self.sub, include_qid=False, prefix_section=False, add_section_separators=True)
        # Check meta fields
    ...
    def test_default_filename_snake_case(self):
        ...
        self.assertEqual(expected, f"test_form-{today.year}-{today.month:02d}-{today.day:02d}.csv")
